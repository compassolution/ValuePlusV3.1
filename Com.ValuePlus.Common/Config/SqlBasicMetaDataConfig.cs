...
namespace Com.ValuePlus.Common.Config
{
    ...
    /// 配置文件读取业务类
    /// </summary>
    public sealed class SqlBasicMetaDataConfig
    {
        /// <summary>
        /// 日志声明
        /// </summary>
        ...
        /// 自身对象实例
        /// </summary>
        private static SqlBasicMetaDataConfig instance = new SqlBasicMetaDataConfig();
        ...
        /// </summary>
        private SqlBasicMetaDataConfig()
        {
            //邮箱配置文件
            ConfigCache = Com.ValuePlus.Config.ConfigFactory.GetConfigManager();
            ConfigCache.Load(@"bin\SqlBasicMetaData.config", Com.ValuePlus.Config.FileTypeEnum.SqlXmlType);
        }

        /// <summary>
        /// 获得此对象的实例
        /// </summary>
        public static SqlBasicMetaDataConfig Instance
        {
            get
            {
                return instance;
        ...
        /// </summary>
        /// <returns></returns>
        public Com.ValuePlus.Utils.SqlBasicMetaData GetUserErrInsert()
        {
            return ConfigCache.GetSqlBasicMetaData("UserErrInsert");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Com.ValuePlus.Utils.SqlBasicMetaData GetUserLoginAuth()
        {
            return ConfigCache.GetSqlBasicMetaData("UserLoginAuth");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Com.ValuePlus.Utils.SqlBasicMetaData GetExitLogin()
        {
            return ConfigCache.GetSqlBasicMetaData("UserLoginExit");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Com.ValuePlus.Utils.SqlBasicMetaData GetUserTreeAdmin()
        {
            return ConfigCache.GetSqlBasicMetaData("UserTreeAdmin");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Com.ValuePlus.Utils.SqlBasicMetaData GetUserTreeNotAdmin()
        {
            return ConfigCache.GetSqlBasicMetaData("UserTreeNotAdmin");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Com.ValuePlus.Utils.SqlBasicMetaData GetUserInfoByUserId()
        {
            return ConfigCache.GetSqlBasicMetaData("TB_HR_USER.selectByUserId");
        }
