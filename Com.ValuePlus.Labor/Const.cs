...
namespace Com.ValuePlus.Labor
{
    public class Const
    {
        ...
        /// 【用户授权】用户同意授权，获取code
        /// </summary>
        public const string Weixin_URL_GetCodeUrl = "https://open.weixin.qq.com/connect/oauth2/authorize?appid={0}&redirect_uri={1}&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect";
