...
{
    /// <summary>
    /// 适用于PC端和WinCe端的DataSet序列和反序列工具类
    /// </summary>
    public class WinCeDataSetHelper
    {
        /// <summary>
        /// 压缩字节数组
        /// </summary>
        ...
        public static byte[] GetZipBytesByDataSet(DataSet _DataSet)
        {
            ...
            System.Xml.Serialization.XmlSerializer ser = new System.Xml.Serialization.XmlSerializer(_DataSet.GetType());
            System.Xml.XmlTextWriter writer = new System.Xml.XmlTextWriter(_MemoryStream, Encoding.Default);
            ser.Serialize(writer, _DataSet);
        ...
        public static DataSet GetDataSetByZipBytes(byte[] byteArray)
        {
            ...
            ///////////WinCE下是没有办法进行BinaryFormatter操作
            //BinaryFormatter _BinaryFormatter = new BinaryFormatter();
            //object o = _BinaryFormatter.Deserialize(_MemoryStream);

            DataSet ds = new DataSet();
            XmlSerializer mySerializer = new XmlSerializer(ds.GetType());
            StreamReader stmRead = new StreamReader(_MemoryStream, System.Text.Encoding.Default);
            object o = mySerializer.Deserialize(stmRead);
