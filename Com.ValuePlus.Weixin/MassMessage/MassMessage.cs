...
namespace Com.ValuePlus.Weixin.MassMessage
{
    /// <summary>
    /// 群发消息
    /// </summary>
    public static class MassMessage
    {
        ...
        //public static long Send(string userName, bool isToAll, string groupId, MessageTypeEnum messageType, string mediaIdOrContent, out ErrorMessage errorMessage)
        //{
        //    long messageId = -1;
        //    if (!isToAll && string.IsNullOrEmpty(groupId))
        //    {
        ...
        //            string.Format("缺少{0}。", messageType == MessageTypeEnum.text ? "文本内容" : "媒体ID"));
        //        return messageId;
        //    }
        ...
        ///// <param name="errorMessage">返回发送是否成功</param>
        ///// <returns>如果发送成功，返回消息ID；否则，返回-1。</returns>
        //public static long Send(string userName, IEnumerable<string> tousers, MessageTypeEnum messageType, string mediaIdOrContent, out ErrorMessage errorMessage)
        //{
        //    long messageId = -1;
        //    if (tousers == null)
        //    {
        ...
        //private static string GetMassMessageJsonString(bool isToAll, string groupId, MessageTypeEnum messageType, string mediaIdOrContent)
        //{
        ...
        ///// <param name="mediaIdOrContent">多媒体id或者文本内容</param>
        ///// <returns>返回群发消息的json字符串。</returns>
        //private static string GetMassMessageJsonString(string[] tousers, MessageTypeEnum messageType, string mediaIdOrContent)
        //{
        //    dynamic msg = new ExpandoObject();
        //    msg.touser = tousers;
        //    if (messageType == MessageTypeEnum.text)
        ...
        ///// <param name="mediaIdOrContent">多媒体id或者文本内容</param>
        ///// <returns>返回群发消息的json字符串。</returns>
        //private static string GetMassMessageJsonString(string touser, MessageTypeEnum messageType, string mediaIdOrContent)
        //{
        //    dynamic msg = new ExpandoObject();
        //    msg.touser = touser;
        //    if (messageType == MessageTypeEnum.text)
        ...
        ///// <param name="errorMessage">返回发送是否成功</param>
        ///// <returns>如果发送成功，返回消息ID；否则，返回-1。</returns>
        //public static long Preview(string userName, string touser, MessageTypeEnum messageType, string mediaIdOrContent, out ErrorMessage errorMessage)
        //{
        //    long messageId = -1;
        //    if (string.IsNullOrEmpty(mediaIdOrContent))
        //    {
