<%@ WebHandler Language="C#" Class="StaffLeaveOverview" %>
...
public class StaffLeaveOverview : HandlerBase, IHttpHandler, System.Web.SessionState.IRequiresSessionState {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            this.GetAnnualLeaveInfo(context,strDCNO,strYearMonth);
        }
    ...
    private void GetAnnualLeaveInfo(HttpContext context,String strDCNO,String strYearMonth)
    {
        try
        {
            try
    ...
    private void GetLeaveSummaryData(HttpContext context,String strDCNO,String strYearMonth)
    {
        ...
        {
            StringBuilder sbSql = new StringBuilder();
            sbSql.Append("select A.TYPENO,A.TYPENAMECHS");
