...
public class WeixinApi : HandlerBase,IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private String strAppId = Com.ValuePlus.SysParams.BaseParamsGetter.GetBasicParamValue("Weixin_appid_EasyHR");
    private String strAppsecret = Com.ValuePlus.SysParams.BaseParamsGetter.GetBasicParamValue("Weixin_appsecret_EasyHR");
