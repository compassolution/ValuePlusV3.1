<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FlowFormDealPage.aspx.cs" Inherits="Flow_WorkFlow_FlowFormDealPage" %>
...
<table class="table" width="100%" height="100%">
    <tr>
        <td class="edit_label" valign="top" align="right">
            <div>
                <asp:LinkButton ID="aBackFlowDealPage" runat="server" CssClass="a_Left" OnClick = "Back_Click">返回流程处理页面</asp:LinkButton>
            </div>
        </td>
    </tr>
    <tr width="100%" height="100%">
        <td valign="top" colspan="2" width="100%" height="100%">
            <iframe id="frmOpPage" name="frmOpPage" runat="server" width="100%" height="500" frameborder="0" src="" style="border: 1px solid #cecece;" scrolling="auto" ></iframe>
        </td>
    </tr>
</table>
</form>
