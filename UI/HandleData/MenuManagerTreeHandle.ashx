<%@ WebHandler Language="C#" Class="MenuManagerTreeHandle" %>
...
public class MenuManagerTreeHandle : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            context.Response.Write(bllMenuManager.GetMenuTreeAll(UserLoginBll.Language));
        }
        catch (Exception ex)
        {
            log.Error(ex);
