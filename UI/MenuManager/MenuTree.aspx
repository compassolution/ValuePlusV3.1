...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MenuTree.aspx.cs" Inherits="MenuManager_MenuTree" %>
...
<table id="tbMain" width="100%" height="100%" cellpadding="0" cellspacing="0" border="0" style="table-layout:fixed;">
<tr>
	<td width="100%" height="100%" colspan="3">
		<table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
		    <tr>
                <td id="tdLeft" valign="top" style="width:350px">
                    <div id="a_tabbar" 
						class="dhtmlxTabBar"
		        ...
		        <td valign="top" style="height:auto" align="center">
				    <iframe id="contentFrame" name="contentFrame" frameborder="0" src="MenuList.aspx" style="height:520px;width:100%;border: 0px solid #cecece;"></iframe>
			    </td>
			</tr>
		</table>
	</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#doctree_box").height(screenHeight - 120);
        $("#contentFrame").height(screenHeight - 120);
    });
</script>
</body>
<script language="javascript" >
	...
	function loadTree(){
		...
		tree_menu.loadXML("../HandleData/MenuManagerTreeHandle.ashx?nu=1",autoselectNode);
	}	
