<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NoticeEdit.aspx.cs" Inherits="Notice_NoticeEdit" %>
    ...
    <div>
        <table border="0" class="warp_table" width="95%" id="tb1" align="center" >
		  ...
		  <tr>
		    ...
		    <td>
		        <asp:TextBox ID="TextBox1" runat="server" Width="90%" MaxLength="100" ></asp:TextBox><font color="red">*</font>
            </td>
            <td background="../common/images/welcome/mail_rightbg.gif">&nbsp;</td>
		  </tr>
		  <tr>
		    ...
		    <td><asp:TextBox ID="TextBox2" runat="server" Width="90%" MaxLength="1000" TextMode="MultiLine" Rows="20"></asp:TextBox><font color="red">*</font></td>
            <td background="../common/images/welcome/mail_rightbg.gif">&nbsp;</td>
		  </tr>
		  <tr>
            <td background="../common/images/welcome/mail_rightbg.gif">&nbsp;</td>
		    ...
		    <td><asp:TextBox ID="TextBox3" runat="server" Width="90%" MaxLength="25" ReadOnly="true"></asp:TextBox><font color="red">*</font></td>
            <td background="../common/images/welcome/mail_rightbg.gif">&nbsp;</td>
		  </tr>
		  <tr>
            <td background="../common/images/welcome/mail_rightbg.gif">&nbsp;</td>
		    ...
		    <td><asp:TextBox ID="TextBox4" runat="server" Width="90%" MaxLength="20" ReadOnly="true"></asp:TextBox></td>
            <td background="../common/images/welcome/mail_rightbg.gif">&nbsp;</td>
		  </tr>
		  <tr>
            <td background="../common/images/welcome/mail_rightbg.gif">&nbsp;</td>
		    ...
		    <td><asp:TextBox ID="TextBox5" runat="server" Width="90%" MaxLength="100"></asp:TextBox></td>
            <td background="../common/images/welcome/mail_rightbg.gif">&nbsp;</td>
		  </tr>
		  <tr>
            <td background="../common/images/welcome/mail_rightbg.gif">&nbsp;</td>
		  ...
		  <tr height="18" align="center">
            ...
            <TD align ="center" colspan="2">
		      <div class="top_table_area">
                  ...
                  <asp:Button ID="Button2" runat="server" Text="删    除" width="100px" height="25px" CssClass="btn_2k3" onclick="Button2_Click"/>
                  <asp:Button ID="Button3" runat="server" Text="返回列表" width="100px" height="25px" CssClass="btn_2k3" onclick="Button3_Click"/>
		      </div>
            </TD>
            <td background="../common/images/welcome/mail_rightbg.gif">&nbsp;</td>
           </tr>
