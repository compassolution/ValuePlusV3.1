...
public partial class WinForm_StaffPRlistFrm : Com.ValuePlus.Web.PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            this.hfTipNotAmount.Value = rmLocResourceManager.GetString("tipNotAmount");

            this.hfPageQueryPRSLIP.Value = BaseConfig.Instance.GetCommonConfigSqlByKey("Page_QueryPREMPL_CalResult").Replace("@", "&");
        }
    }
}