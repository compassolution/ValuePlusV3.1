//  <input name=txt><input type=button value=setday ondblclick="datePicker.show(this);">
...
{  
    ...
    this.dateInput = null; 
    this.timer = null; 
    this.language = "en-us";//语言环境
    this.EnglishWeek = new Array('SUN','MON','TUE','WED','THU','FRI','SAT');  
    this.EnglishMonth = new Array('Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'); 
}; 
...
{ 
    var sWidth = "140px"
    if(this.language == "en-us"){//英文环境
        var sWidth = "190px"
    }
    var str = '<style type="text/css">\n'; 
    str += '.calendar{position:absolute;width:'+sWidth+'!important;width /**/:142px;height:184px!important;height /**/:174px;background-color:'+this.style.bodyBackColor+';border:1px solid ' + this.style.borderColor + ';left:0px;top:0px;z-index:9999;}\n'; 
    str += '.cdrHeader{background-color:'+ this.style.headerBackColor +';width:'+sWidth+';height:22px;font-size:12px;color:'+this.style.headerFontColor+';}\n'; 
    str += '.cdrWatermark{position:absolute;left:0px;top:55px;width:'+sWidth+';font-family: Arial Black;font-size:50px;color:'+this.style.watermarkColor+';z-index:1;text-align:center;}\n'; 
    str += '.cdrBodyBar{background-color:' + this.style.bodyBarBackColor + ';font-size:12px;color:' + this.style.bodyBarFontColor + ';width:'+sWidth+';height:20px;}\n'; 
    str += '.cdrBody{width:'+sWidth+';height:122px!important; height /**/:110px;font-size:12px;cursor:pointer;color:' + this.style.bodyFontColor + ';}\n'; 
...
{ 
    var strPreYear = "上一年份";
    var strNextYear = "下一年份";
    var strPreMonth = "上一月份";
    var strNextMonth = "下一月份";    
    if(this.language == "en-us"){//英文环境
        strPreYear = "Previous Year";
        strNextYear = "Next Year";
        strPreMonth = "Previous Month";
        strNextMonth = "Next Month"; 
    }
    var str = '<table Author="alin" class="cdrHeader" cellSpacing="2" cellPadding="0"><tr Author="alin" align="center">\n'; 
    str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="previousYear" title="'+strPreYear+'" style="cursor:pointer;width:10px;" onclick="'+this.Obj+'.onChangeYear(false);"><<</td>\n'; 
    str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="previousMonth" title="'+strPreMonth+'" style="cursor:pointer;width:10px;" onclick="'+this.Obj+'.onChangeMonth(false);"><</td>\n'; 
    ...
    str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="nextMonth" title="'+strNextMonth+'" style="cursor:pointer;width:10px;" onclick="'+this.Obj+'.onChangeMonth(true);">></td>\n'; 
    str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" onmouseout="this.className=\'\'" id="nextYear" title="'+strNextYear+'" style="cursor:pointer;width:10px;" onclick="'+this.Obj+'.onChangeYear(true);">>></td></tr>\n'; 
    str += '</table>\n'; 
    return str; 
}; 
...
{ 
    ...
    {   
        ...
        if(this.language == "en-us"){//英文环境
            str += 'onclick="' + this.Obj + '.bindDate(\'' + _date.toFormatString("-") + '\')">'+this.EnglishMonth[i-1]+'</td></tr>\n';
        }else{
...
{ 
    ...
    {   
        if(document.body.clientHeight>_obj.clientHeight){
            _obj.style.top = (_target.y - _obj.clientHeight+50) + 'px'; 
        }else{
            _obj.style.top = (_target.y + _evObj.clientHeight) + 'px'; 
        }
    } 
...
{ 
    ...
    if(this.language == "en-us"){//英文环境
        ...
        var i = parseInt(this.date.toFormatString("mm"));
        _curMonth.innerHTML = this.EnglishMonth[i-1]; 
    }
